...
def classify_text(text_classifcation_model, text_classification_data_path, text_to_classify):
    jutsu_classifier = JutsuClassifier(model_path=text_classifcation_model, data_path=text_classification_data_path, hugging_face_token=os.getenv("huggingface_token"))
